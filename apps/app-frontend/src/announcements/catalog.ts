...
export const launcherAnnouncements: readonly LauncherAnnouncement[] = [
		...
		changes: {
			added: [
				...
				},
				{
					...
					'zh-CN': '新增浏览购物车中多个内容项目的并发批量下载。',
				},
				{
					'en-US':
						'Added SPA navigation for browse tabs with sticky toolbars, pagination controls, and go-to-page support.',
					'zh-CN': '新增浏览页面标签的 SPA 导航、固定工具栏、分页控件和跳转页面功能。',
				},
				{
					'en-US':
						'Added unified loading skeletons, content-card fade-in effects, refresh masks, and empty states across browse pages.',
					'zh-CN': '为浏览页面统一添加加载骨架屏、内容卡片淡入效果、刷新遮罩和空状态。',
				},
				{
					'en-US': 'Added installed-state indicators to browse actions.',
					'zh-CN': '为浏览页面操作按钮添加已安装状态提示。',
				},
				{
					'en-US': 'Added the copying guidelines link back to About settings.',
					'zh-CN': '在关于设置中重新添加版权使用指引链接。',
				},
			],
			changed: [
				{
				...
				},
				{
					...
					'zh-CN':
						'通过下载、校验与数据库写入流水线化、数据库批处理及内存实时进度，改进 Modrinth、CurseForge、mrpack 和 ZIP 整合包下载。',
				},
				{
					'en-US':
						'Refactored installation, upgrade, loader, recovery, cancellation, and database workflows for better reliability.',
					'zh-CN': '重构安装、升级、加载器、恢复、取消和数据库流程，提升可靠性。',
				},
				{
					'en-US':
	...
	},
	{
		...
		changes: {
			added: [
				...
				{
					'en-US': 'Added an option to select the main world biome height in the seed map.',
					'zh-CN': '新增种子地图中选择主世界群系高度的选项。',
				},
				{
			...
			changed: [
				...
				{
					'en-US': 'Disable the corresponding buttons when database operations are unavailable.',
					'zh-CN': '当数据库操作不可用时禁用相应按钮。',
				},
				{
	...
	},
	{
		...
		changes: {
			fixed: [
				{
					'en-US': 'Fix the issue introduced in 1.9.2 where instances fail to start.',
					'zh-CN': '修复从 1.9.2 引入的实例无法启动的问题。',
				},
			],
		},
	},
